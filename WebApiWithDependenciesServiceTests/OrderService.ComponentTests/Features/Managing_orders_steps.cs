...
using OrderService.ServiceTests.Infrastructure;
using Rebus.Bus;
using Shouldly;
using Xunit;
...
internal class Managing_orders_steps : IDisposable
{
    ...
    public Managing_orders_steps(OrderServiceClient client, MockAccountService accountService, TestBus testBus)
    {
        _client = client;
